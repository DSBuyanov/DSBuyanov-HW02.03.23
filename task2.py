...
# поэтому ко времени сбора на них выросло различное число ягод – на i-ом кусте выросло РАНДОМНОЕ колличество ягод.
...
import random
n = int(input())
berries = [random.randint(0, 100) for _ in range(n)]
max_berries = 0
